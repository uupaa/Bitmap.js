...
function Bitmap_createBlob(source,   // @arg Uint8Array|Uint8ClampedArray
    ...
    header.set(
        [].concat(
            // --- BITMAPFILEHEADER ---
            SIGNATURE,                  // bfType
            _to4(FILE_SIZE),            // bfSize
            [0x00, 0x00],               // bfReserved1
            [0x00, 0x00],               // bfReserved2
            _to4(DATA_OFFSET),          // bfOffBits
            // --- BITMAPV5HEADER ---
            _to4(DIB_HEADER_SIZE),      // biSize
            _to4(width),                // biWidth
            _to4(NEGATIVE_HEIGHT),      // biHeight
            [0x01, 0x00],               // biPlanes
            [0x20, 0x00],               // biBitCount - 0x20 = 32bit
            [0x03, 0x00, 0x00, 0x00],   // biCompression - 0x03 = BI_BITFIELDS
            _to4(DATA_SIZE),            // biSizeImage
